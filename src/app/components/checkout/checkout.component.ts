...
import { SiaShopValidators } from 'src/app/validators/sia-shop-validators';
...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      customer: this.formBuilder.group({
        firstName: new FormControl('',
          ...
          SiaShopValidators.notOnlyWhitespace]),
    ...
    */
    ...
    this.SiaShopFormService.getCountries().subscribe(
      data => {
  ...
  */
  ...
  getStates(formGroupName: string) {
    ...
    this.SiaShopFormService.getStates(countryCode).subscribe(
      data => {
